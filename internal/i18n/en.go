...
var en = map[string]string{
	...
	"rw.torrent_user":           "⛔️ <b>Torrent traffic detected</b>\n\nDownloading torrents through the service is prohibited. Your IP address is temporarily blocked for %s (until %s).\n\nTurn off the torrent client — access is restored automatically. Repeated violations may lead to subscription suspension.",
	...
	"wh.torrent_line":       "🚫 <b>Torrent blocker</b>: with the torrent-blocker node plugin enabled, the panel posts reports to <code>/webhook/remnawave</code>. The buttons below toggle notifications: a detailed report for the admin, a temporary-block warning for the user.",
