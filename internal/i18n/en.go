...
var en = map[string]string{
	...
	"sub.addsub":            "➕ Add-on server: <b>%s</b> of %s GB left",
	"sub.addsub_unlim":      "➕ Add-on server: <b>unlimited</b>",
	"sub.addsub_out":        "➕ Add-on server: <b>traffic used up</b> — its servers are temporarily unavailable",
	"sub.addsub_off":        "➕ Add-on server: <b>disabled</b>",
	...
	"ap.choose":         "🔁 <b>How would you like to pay for %s — %s?</b>\n\n<b>One-off payment</b> — charged once, you renew manually later.\n\n<b>With automatic renewal</b> — YooKassa remembers your card and the bot renews the subscription for the same period at the current price, %s. You can turn it off any time with one button: «My subscription» → «Auto-renewal». Nothing is charged after you turn it off.",
	"ap.btn_pay_auto":   "🔁 Pay with auto-renewal",
	"ap.btn_pay_once":   "💳 One-off payment",
	"ap.pay_hint":       "🔁 The card will be saved for auto-renewal: next charge %s. Turn it off in «My subscription» → «Auto-renewal».",
	"ap.enabled_notice": "🔁 <b>Auto-renewal is on</b>\n\nThe bot will renew your subscription for %s — charged %s. The amount is the price at the moment of the charge; you will get a notification here.\n\nYou can turn it off any time: «My subscription» → «Auto-renewal» → «Turn off».",
	...
	"ap.btn_buy":        "💳 Pay with auto-renewal",
	...
	"ap.off_title":      "🔁 <b>Auto-renewal is off</b>\n\nWhen on, the bot renews the subscription itself (%s) with the saved card, so you never have to remember about payment. The card is stored on YooKassa's side — the bot never sees or keeps the card number.\n\nTo enable it, pay for a subscription and choose «Pay with auto-renewal».",
	...
	"admin.yk_btn_autodefault": "⭐️ Offer first",
