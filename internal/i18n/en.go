...
var en = map[string]string{
	...
	"paylog.errors_caption": "🚨 Payment failures: %d entries. Every error across all methods — invoice creation, webhooks, signatures, subscription delivery, auto-renewal.",
	...
	"hl.underpaid":          "⚠️ Less than the invoice amount was paid. Send the remainder to the same address or contact support — the admin has been notified.",
	...
	"hl.admin_underpaid":    "⚠️ Heleket: underpayment on invoice <code>%s</code> (invoice for %s). Subscription NOT granted — handle manually.",
	"hl.admin_locked":       "⛔️ Heleket: payment on invoice <code>%s</code> (%s) is on AML hold. Subscription NOT granted.",
