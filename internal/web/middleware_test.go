...
func TestClientIP_TakesRightmostUntrusted(t *testing.T) {
	...
	if got := clientIP(req("127.0.0.1:1234", "192.0.2.4, 203.0.113.7")); got != "203.0.113.7" {
