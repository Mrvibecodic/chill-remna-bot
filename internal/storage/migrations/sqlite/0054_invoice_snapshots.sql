...
--
-- Ключ — человек, способ оплаты и срок. Два счёта на РАЗНЫЕ сроки живут в
-- разных строках и друг друга не трогают; два счёта на ОДИН срок различить
-- нечем (payload и сумма у них совпадают, а payload менять нельзя) — там
-- побеждают условия последнего выставленного счёта.
