...
- **Свои устройства** — список подключений под счётчиком «Устройства: 2 / 3» (в боте, Mini App и веб-кабинете): платформа и ОС, модель, отпечаток и даты первого и последнего подключения. Какие из этих полей видит человек, решает владелец бота (**Интерфейс → 📱 Устройства**).
