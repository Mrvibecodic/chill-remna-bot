...
- **Свои устройства** — список подключений под счётчиком «Устройства: 2 / 3» (в боте, Mini App и веб-кабинете): платформа и ОС, модель, приложение клиента, отпечаток и дата подключения. Какие из этих полей видит человек, решает владелец бота (**Интерфейс → 📱 Устройства**).
