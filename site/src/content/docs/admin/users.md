...
4. Для кнопок «Снять блокировку IP» и «В исключения» токену панели 3.x нужны скоупы `node-plugins:` list, update, executor — см. [«Права токена панели»](/reference/panel-scopes/).
